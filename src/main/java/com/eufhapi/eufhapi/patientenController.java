        ...
        public List<Patient> GetAllPatienten() throws Exception {
                ...
                try {
                        ...
                        for (int i = 0; i < Data.size(); ++i) {
                                ...
                                allPatients.add(new Patient(currentPatient.getId(), currentPatient.getFirstName(),
        ...
        public Patient GetPatientById(@PathVariable int id) {
                ...
                for (int i = 0; i < Data.size(); ++i) {
                        ...
                        if (currentPatient.getId() == id) {
                                ...
                                currentPatient.addTreatment(new Treatment(1, LocalDate.of(2023, 4, 27)));
                                currentPatient.addTreatment(new Treatment(2, LocalDate.of(2024, 4, 27)));
                                currentPatient.addTreatment(new Treatment(3, LocalDate.of(2025, 4, 27)));
